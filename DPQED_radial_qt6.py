...
from PyQt6.QtCore import Qt, QObject, QEvent, QMetaType, QRectF
from PyQt6.QtGui import (QKeySequence, QFont, QColor, QShortcut,
                         QFontMetricsF, QPainter)
...
class RadiometricDashboard(QMainWindow):
    def __init__(self):
        ...
        self.lbl_context.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.lbl_context.setFrameShape(QFrame.Shape.StyledPanel)
    ...
    def _make_writer(self, path, fields):
        ...
        return QgsVectorFileWriter(path, "UTF-8", fields,
                                   WKB_POLYGON, self.proj_crs, "ESRI Shapefile")
    ...
    def apply_map_tool(self, _checked=None):
        ...
        cursor = {TOOL_PAN: Qt.CursorShape.OpenHandCursor,
                  TOOL_SELECT: Qt.CursorShape.ArrowCursor}.get(mode, Qt.CursorShape.CrossCursor)
        try:
